...
package com.codeskraps.sbrowser.bill_util;
...
/**
	...
	public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
			...
			if (mPurchaseListener != null) {
				mPurchaseListener.onIabPurchaseFinished(new IabResult(BILLING_RESPONSE_RESULT_OK,
						"Success"), purchase);
			}
	...
	public Inventory queryInventory(boolean querySkuDetails, List<String> moreItemSkus,
		...
		try {
			...
			if (r != BILLING_RESPONSE_RESULT_OK) { throw new IabException(r,
	...
	void consume(Purchase itemInfo) throws IabException {
		...
		if (!itemInfo.mItemType.equals(ITEM_TYPE_INAPP)) { throw new IabException(
				IABHELPER_INVALID_CONSUMPTION, "Items of type '" + itemInfo.mItemType
						+ "' can't be consumed."); }
	...
	public static String getResponseDesc(int code) {
		String[] iab_msgs = ("0:OK/1:User Canceled/2:Unknown/"
				...
				+ "5:Developer Error/6:Error/7:Item Already Owned/" + "8:Item not owned")
				.split("/");
		String[] iabhelper_msgs = ("0:OK/-1001:Remote exception during initialization/"
				+ "-1002:Bad response received/" + "-1003:Purchase signature verification failed/"
				+ "-1004:Send intent failed/" + "-1005:User cancelled/"
				+ "-1006:Unknown purchase response/" + "-1007:Missing token/"
				+ "-1008:Unknown error/" + "-1009:Subscriptions not available/"
	...
	int getResponseCodeFromIntent(Intent i) {
		...
		if (o == null) {
			...
			logError(o.getClass().getName());
			throw new RuntimeException("Unexpected type for intent response code: "
					+ o.getClass().getName());
		}
	}
	...
	void logWarn(String msg) {
		L.w(mDebugTag, "In-app billing warning: " + msg);
	}
}
